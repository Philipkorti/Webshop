...
if(isset($rezes)){
  foreach($rezes as $rez){ 
    if($rez->parent == $id){
      ...
      echo"<p>Rezension von ".$rez->user." vom ".$rez->date."</p>
      <p>".$rez->text."</p>";
      if($rez->likes !=0){
        foreach($likes as $like){
          if($like->RezensionID == $rez->id){
        ...
        if($check == 1){
          echo "<a role='button' onclick='like(".$rez->id.",$id)'><svg xmlns='http://www.w3.org/2000/svg' width='16' height='16' fill='currentColor' class='bi bi-suit-heart' viewBox='0 0 16 16'>
